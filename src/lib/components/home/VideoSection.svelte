...
<style>
  ...
  .dn-video-card__duration { position: absolute; bottom: 10px; right: 10px; padding: 3px 6px; border-radius: 4px; background: #171a20; color: #fff; font-size: var(--dn-text-caption); font-weight: var(--dn-weight-semibold); line-height: var(--dn-leading-meta); }
