...
const brandArtwork = [
  { label: 'Land Rover', image: '/assets/images/brand-official/land-rover-official.svg', width: 228, height: 120, bounds: [0, 0, 228, 120] },
  ...
  { label: 'Mercedes-Benz', image: '/assets/images/brand-official/mercedes-benz-official.svg', width: 29.35, height: 28.35, bounds: [0, 0, 29.35, 28.35] },
  ...
  { label: 'Audi', image: '/assets/images/brand-official/audi-official.svg', width: 52, height: 18, bounds: [0, 0, 52, 18] },
