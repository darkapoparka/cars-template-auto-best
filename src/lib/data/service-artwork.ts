...
export const serviceArtwork = {
  ...
  value: { src: '/assets/images/template/service-sell-euros-v1.webp', width: 1536, height: 1024, crop: [40, 50, 1420, 880] },
  contact: { src: '/assets/images/template/service-import-v1.webp', width: 1536, height: 1024, crop: [45, -10, 1350, 980] },
